...
//'&d=monsterid',
"&s=",24].join("");a.innerHTML='<img src="'+d+'" style="border: none; vertical-align: middle"/> '+a.innerHTML},d=function(){try{var a,b,d=document.getElementsByTagName("a"),e=d.length,f=/^mailto:.*@/;for(b=0;e>b;b++)a=d[b],f.test(a.href)&&!function(){var b=a;setTimeout(function(){c(b)},10)}()}catch(g){alert("debug: "+g)}};a?d():window.addEventListener("load",d,!1)}();