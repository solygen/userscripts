...
// ==/UserScript==
!function(){"use strict";function a(a){var b=a.find(".col_9").clone();b.removeClass("col_9").addClass("col_9a").insertBefore(a.find(".col_9"))}function b(a,b,c){a&&(b<=parseFloat(a,10)+k?c.find(".col_9").css("color","green"):c.find(".col_9").css("color","red"))}function c(a){var b=a.find(".col_9").text().replace(",",".").replace("€","").trim();return parseFloat(b,10)}function d(){var a,b=$(".H1_PageTitle").text().split(" ")[2],c=0;//sum
$.each(l,function(){c+=parseFloat(this)||0}),//average
a=Math.round(c/l.length*100)/100,//add level to dom/local storage
$(".H1_PageTitle").text($(".H1_PageTitle").text()+" ("+a+")"),a=localStorage.setItem("seller:"+b,a)}var e,f,g=$(".navBarTopText").length?$($(".navBarTopText").children()[0]):$($("#siteContents").children()[2]),h=$("tbody"),i=$("tbody").find("tr"),j=0,//flag green
