...
// ==/UserScript==
!function(){"use strict";function a(a){for(var b=["sec","min","hour","day","week","month","year","decade"],c=["60","60","24","7","4.35","12","10"],d=new Date,e=(d-a)/1e3-3600,f=0;e>=c[f]&&f<c.length-1;f++)e/=c[f];return e=Math.round(e),1!==e&&(b[f]+="s"),e+" "+b[f]}//logger
unsafeWindow.ox.log={add:function(a,b){b=b||"general",unsafeWindow.ox.logdata=unsafeWindow.ox.logdata||{},unsafeWindow.ox.logdata[b]=unsafeWindow.ox.logdata[b]||[],unsafeWindow.ox.logdata[b].push(a)},show:function(a){unsafeWindow.ox.logdata=unsafeWindow.ox.logdata||{},console.log(JSON.stringify(unsafeWindow.ox.logdata[a]||[],void 0,2))},clear:function(a){unsafeWindow.ox.logdata=unsafeWindow.ox.logdata||{},a?unsafeWindow.ox.logdata[a]=void 0:unsafeWindow.ox.logdata=void 0}};var b=setInterval(function(){var c=new Date,d=$($(".launchers").find("li")[0]).clone();return d.length?(//set date by ox version
