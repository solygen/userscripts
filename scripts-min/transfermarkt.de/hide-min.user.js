...
// ==/UserScript==
!function(){//all
$("iframe, .werbung, .naviback").remove(),$(".bildquelle").remove(),//landing page only
window.location.href.length<=29&&($(".werbung_wetten").parent().remove(),$(".news-topthema, .news-weitere").parent().removeClass("eight").addClass("twelve"))}();