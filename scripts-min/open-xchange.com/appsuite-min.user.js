...
d.find("a").text(a(c)).attr("href",'javascript: ox.cache.clear().done(function() { console.log("cache clear"); })').css("color","rgb(255, 122, 0)"),$(".launchers").prepend(d),clearInterval(b),void 0):!1},500)}();