...
register:function(){var a=setInterval(function(){$("#kartenOverlay").css("border","0px").css("width","auto"),$("#kartenOverlayBild").css("height","380px").css("width","266px"),$("#kartenOverlayContent").css("display","none"),$("#kartenOverlay").length&&clearInterval(a)},1e3)},tab:function(){//TODO: own tab
// var bar = $('.ui-tabs-nav'),
...
$(".inhalt").prepend(a.addClass("custom"))}},process:function(){this.remove(),this.set(),this.register(),this.tab()}},i={//update rarity
...
this.rarity(b.css("color"),f.num,f.name)},//replace link
replace:function(){var a=$(f.row.find(".cardlink")),b=a.attr("href"),c=b.split("=").pop(),d="https://www.magickartenmarkt.de/?mainPage=showSearchResult&searchFor="+c+"&v=card&s=cname&card="+c;a.attr("href",d)},//identify proxies
