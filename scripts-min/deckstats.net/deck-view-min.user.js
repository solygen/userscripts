...
replace:function(){for(var a=$("a.cardlink"),b=0;b<a.length;b++){var c=$(a[b]),d=c.attr("href"),e=d.split("=").pop(),f="https://www.magickartenmarkt.de/?mainPage=showSearchResult&searchFor="+e+"&v=card&s=cname&card="+e+"&redirect=true&referrer=solygen";c.attr("href",f)}},tab:function(){//TODO: own tab
// var bar = $('.ui-tabs-nav'),
